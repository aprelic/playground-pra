...
public class PositionService {
    ...
    @Autowired
    public PositionService(TransactionTemplate transactionTemplate, PositionRepository positionRepository, CounterpartyRepository counterpartyRepository) {
    ...
    public void init() {
        transactionTemplate.execute(new TransactionCallbackWithoutResult() {
            ...
            protected void doInTransactionWithoutResult(TransactionStatus status) {
                Counterparty counterparty = new Counterparty(1001L, "CNTPRTY_1001", "Counterparty Name 1001");
